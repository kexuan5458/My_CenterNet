...
do
  cp /data/RADIATE/${folder}/Navtech_Cartesian/*.png /data/RADIATE/mini_train/
done
# test
for folder in 'night_1_0' 'junction_1_10' 'city_7_0' 'junction_2_6' 'fog_6_0' 'rain_3_0' 'rain_4_0' 'night_1_5' 'night_1_4' 'motorway_2_2' 'junction_1_11' 'night_1_2' 'snow_1_0' 'city_3_7' 'junction_3_2' 'fog_8_1' 'junction_1_12'
do
  cp /data/RADIATE/${folder}/Navtech_Cartesian/*.png /data/RADIATE/mini_test/
done
