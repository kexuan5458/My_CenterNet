...
radar_path = "/data2/itri/DCV/single_sensor_data/bag1/radar_cart_0_200_timelapsed"
lidar_path = "/data2/itri/DCV/single_sensor_data/bag1/baraja_1"
lidar2_path = "/data2/itri/DCV/single_sensor_data/bag1/baraja_2"
...
def combine_radar_lidar(radar_stamp, lidar_stamp, lidar2_stamp, livox_stamp, overlap):
	...
	# final.save("/data2/itri/DCV/single_sensor_data/bag1/radar_lidar_overlay/{}.png".format(k))
	final.save("/root/NCTU/research/itri_related/20201007/code/overlay/bag1_overlay_test/{}.png".format(k))
