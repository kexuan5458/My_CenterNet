...
class Evaluator():
    ...
    __coco_key_mapping = {
        ...
        'map/iou=0.20/area=all/max_dets=100': 'MSCOCO_Precision/mAP@.20IOU', # sungting
        'map/iou=0.30/area=all/max_dets=100': 'MSCOCO_Precision/mAP@.30IOU', # sungting
        ...
        'ap/iou=0.20/area=all/max_dets=100': 'MSCOCO_Class_{}/Precision/AP@.20IOU', # sungting
        'ap/iou=0.30/area=all/max_dets=100': 'MSCOCO_Class_{}/Precision/AP@.30IOU', # sungting
    ...
    def add_batch(
            ...
            gt_ids, gt_areas, image_shape, pred_kps=None, gt_kps=None, **kwargs):
    ...
    def evaluate(self):
        ...
        with RedirectOut(os.devnull) as out:
            ...
            ### set cocoeval params <
            self.coco_eval.params.iouThrs = np.arange(.2,1,.05)
            ### set cocoeval params >
        ...
        all_kwargs = {
            'ap/iou=0.20/area=all/max_dets=100': {
                'ap': True, 'iou_thresh': 0.2, 'area_range': 'all',
                'max_detection': 100},
            'ap/iou=0.30/area=all/max_dets=100': {
                'ap': True, 'iou_thresh': 0.3, 'area_range': 'all',
                'max_detection': 100},
    ...
    def __summarize(self,
        ...
        if ap:
            ...
            if iou_thresh is not None:
                val_value = val_value[iou_thresh == np.round(iou_threshs, 3)]
